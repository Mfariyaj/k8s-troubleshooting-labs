#!/bin/bash
set -e
echo "🚀 Lab 45: policy non compliant resources"
echo "============================================================"
echo ""
echo "📋 Category: Governance"
echo "💰 Cost: FREE"
echo "📋 Scenario: Resources not compliant with org policies"
echo ""
...
echo "   az policy state list --filter 'complianceState eq NonCompliant'"
echo ""
