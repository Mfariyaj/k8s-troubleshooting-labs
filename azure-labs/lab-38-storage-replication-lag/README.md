...
# Lab 38: storage replication lag
...
## 📚 What This Teaches
GRS storage: replication lag, failover considerations
...
Run: az storage account show -n <sa> --query statusOfSecondary
</details>
...
```bash
# Azure CLI:
az storage account show -n <sa> --query statusOfSecondary
