...
# Lab 31: function app scaling stuck
...
## 📚 What This Teaches
Consumption plan not scaling: storage account issue
...
Run: az functionapp show -n <func> -g <rg> --query state
</details>
...
```bash
# Azure CLI:
az functionapp show -n <func> -g <rg> --query state
