#!/bin/bash
# Deploy Lab 06 - List Operations

LAB_DIR="/tmp/python-lab-06"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo "🔬 Lab 06: Python List Operation Errors"
echo "========================================="
echo ""
...
echo ""
echo "----------------------------"
echo "❌ The script has list operation errors!"
echo ""
echo "📝 Your task: Fix the list bugs in $LAB_DIR/broken_script.py"
