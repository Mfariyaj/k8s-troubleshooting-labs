# 📖 Detailed Guide: lab-47-org-cloudtrail-missing-events

## Category: Multi-Account

## Understanding the Problem
CloudTrail not logging in member accounts: org trail not configured
...
1. Open **AWS Console** → Search for **Organizations**
