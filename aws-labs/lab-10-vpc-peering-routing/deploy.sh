#!/bin/bash
set -e
echo "🚀 Lab 10: Networking - VPC peering connected but traffic not flowing: route tables missing entries"
echo "============================================================"
echo ""
...
echo ""
echo "📋 Scenario: VPC peering connected but traffic not flowing: route tables missing entries"
echo ""
