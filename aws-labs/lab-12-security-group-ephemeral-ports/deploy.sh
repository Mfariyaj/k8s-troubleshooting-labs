#!/bin/bash
set -e
echo "🚀 Lab 12: Networking - App works on port 443 but response never comes back: ephemeral ports blocked"
echo "============================================================"
echo ""
...
echo ""
echo "📋 Scenario: App works on port 443 but response never comes back: ephemeral ports blocked"
echo ""
