#!/bin/bash
set -e
echo "🚀 Lab 15: Networking - Private hosted zone DNS not resolving: VPC association missing"
echo "============================================================"
echo ""
...
echo ""
echo "📋 Scenario: Private hosted zone DNS not resolving: VPC association missing"
echo ""
