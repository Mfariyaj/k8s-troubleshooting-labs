#!/bin/bash
set -e
echo "🚀 Lab 13: Networking - NACL blocking return traffic: forgot NACLs are STATELESS unlike SGs"
echo "============================================================"
echo ""
...
echo ""
echo "📋 Scenario: NACL blocking return traffic: forgot NACLs are STATELESS unlike SGs"
echo ""
